...
window.JOT\_formatRelativeToNow=function(a,b){a=((new Date).getTime()-a)/6E4;if(1440<=a||0>a)return null;var c=0;60<=a&&(a/=60,c=2);2<=a&&c++;return b?window.JOT\_siteRelTimeStrs[c].replace("\_\_duration\_\_",Math.floor(a)):window.JOT\_userRelTimeStrs[c].replace("\_\_duration\_\_",Math.floor(a))}; })()
 ...
 var breadcrumbs = [{"path":"/project","deleted":false,"title":"\u0420\u041e\u0411\u041e\u0422\u0418/WORKS selection","dir":"ltr"},{"path":"/project/arhive-of-works-and-projects","deleted":false,"title":"arhive of works and projects","dir":"ltr"}];
...
arhive of works and projects - ladanakonechna.com
...
arhive of works and projects





| *********Висновок/Conclusion*****[>>](visnovok-conclusion)*****

---************Ентузіазм/Enthusiasm******[>>](entuziazm-enthusiasm)***

---

**Чужа історія/Somebody else's (hi)story*****[>>](cuza-istoria-somebody-else-s-hi-story)***

---

***Сила мистецтва/The power of art*****[>>](sila-mistectva-the-power-of-art)**

---

*****Вже сказане/It has been already said*****[>>](vze-skazane-it-has-been-already-said)****** | ***Дорогий Фелікс Гонзалес-Торрес, чи можемо ми відмовитись від солодкого?/ Dear Felix Gonzales-Torres, **can we give up sweets? ***[>>](dorogij-feliks-gonzales-torres-ci-mozemo-mi-vidmovitis-vid-solodkogo-dear-felix-gonzales-torres-can-we-give-up-sweets)***

---***Пряма дорога/Direct way**[>>](prama-doroga-direct-way)****

---

***Магічне захисне коло**/Magic protective circle*[>>](magicne-zahisne-kolo-magic-protective-circle-1)**

---

******П****асаж/Passage********[>>](pasaz-passage)**

---

***********Світ (не) належить всім/The world is (not) belong for everybody***********[>>](svit-ne-nalezit-vsim-the-world-is-not-belong-for-everybody)********** | ******SALE[>>](sale)

---***Уроки німецької/German lessons[>>](uroki-nimeckoie-german-lessons)***

---

Стіни, побудовані не мною/The walls are built not by me[>>](stini-pobudovani-ne-mnou-the-walls-are-built-not-by-me)

---

Fashion Ukraine[>>](fashion-ukraine)

---

***Речові докази/The testimony of things[>>](recovi-dokazi-the-testimony-of-things)
...
[Sign in](https://accounts.google.com/ServiceLogin?continue=http://sites.google.com/a/ladanakonechna.com/ladanakonechna-com/project/arhive-of-works-and-projects&service=jotspot)|[Report Abuse](http://sites.google.com/a/ladanakonechna.com/ladanakonechna-com/system/app/pages/reportAbuse)|[Print Page](javascript:;)|Powered By **[Google Sites](http://sites.google.com/site)**
