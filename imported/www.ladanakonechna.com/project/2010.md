...
window.JOT\_formatRelativeToNow=function(a,b){a=((new Date).getTime()-a)/6E4;if(1440<=a||0>a)return null;var c=0;60<=a&&(a/=60,c=2);2<=a&&c++;return b?window.JOT\_siteRelTimeStrs[c].replace("\_\_duration\_\_",Math.floor(a)):window.JOT\_userRelTimeStrs[c].replace("\_\_duration\_\_",Math.floor(a))}; })()
 ...
 var breadcrumbs = [{"path":"/project","deleted":false,"title":"\u0420\u041e\u0411\u041e\u0422\u0418/WORKS selection","dir":"ltr"},{"path":"/project/2010","deleted":false,"title":"2010","dir":"ltr"}];
...
| 
**Works:**[Перспектива/Perspective
(2010-2011)](perspektiva-perspective)
[Листівки/Cards](listivki-cards)
 | 
**Group exhibitions:**Court
Experiment, Visual Culture Research Center, Center of Study of
Society, Curatorial Union Hudrada together with
tranzit.at, Kyiv, Ukraine;
Art-Kyiv contemporary 2010, parallel exhibition, Art Arsenal, Kyiv;
PROTESTS,
SUBVERSIONS, COMMUNITIES, MARKETS: public space in
contemporary Ukrainian art –  screening, Flat space, Chisinau, Republica Moldova;
Those, who came at the start of 2000, M17 Contemporary art centre, Kyiv, Ukraine;
September gallery
tour. International artist awardees showing: Anna
Hoetjes, Lada Nakonechna, Leo Kogan, Osvaldo Budet, Nikita
Kadan, Kylie Manning, LIAprogram, Spinnerei, Leipzig,
Germany;
At
home in Wollishofen, artfoyer Cavigelli, Zurich, Switzerland;
Art Paris,
Grand Palais, Paris, France;
Minimal
differences, White box, Нью-Йорк, США*;
Over the counter, Kunsthalle
Mucsarnok, Будапешт,
Hungary*;
Gruppenausstellung
der aktuellen KünstlerInnen der Stiftung BINZ39, Zurich, Switzerland;
[ЯКЩО](https://sites.google.com/a/ladanakonechna.com/ladanakonechna-com/contact/goog_717647265)[/](https://sites.google.com/a/ladanakonechna.com/ladanakonechna-com/contact/goog_717647265)ЕСЛИ /
IF. Ukrainian Art in Transition, PERMM
museum, Perm, Russia;
Euro
Renovation in Europe, Kunstraum
München, Munich, Germany*;
Great Surprise, National Art Museum of Ukraine, Kyiv *;
SUPERMARKET - the artist-run
art fair, Stockholm, Sweden*;
Let’s
Talk about Nationalism! Between Ideology and Identity, Kumu Art
...
[Sign in](https://accounts.google.com/ServiceLogin?continue=http://sites.google.com/a/ladanakonechna.com/ladanakonechna-com/project/2010&service=jotspot)|[Report Abuse](http://sites.google.com/a/ladanakonechna.com/ladanakonechna-com/system/app/pages/reportAbuse)|[Print Page](javascript:;)|Powered By **[Google Sites](http://sites.google.com/site)**
