...
window.JOT\_formatRelativeToNow=function(a,b){a=((new Date).getTime()-a)/6E4;if(1440<=a||0>a)return null;var c=0;60<=a&&(a/=60,c=2);2<=a&&c++;return b?window.JOT\_siteRelTimeStrs[c].replace("\_\_duration\_\_",Math.floor(a)):window.JOT\_userRelTimeStrs[c].replace("\_\_duration\_\_",Math.floor(a))}; })()
 ...
 var breadcrumbs = [{"path":"/project","deleted":false,"title":"\u0420\u041e\u0411\u041e\u0422\u0418/WORKS selection","dir":"ltr"},{"path":"/project/2015","deleted":false,"title":"2015","dir":"ltr"}];
...
| **Роботи/Works**
[Так звані/The So-Called](tak-zvani-the-so-called)[Війна в Україні/War in Ukraine](war-in-ukraine)
[Град/Hail
(Grad)](grad-hail) (2015-2017)
[Об'єднання видимого/Merge Visible](merge-visible) (2015-2017)
Обман дистанції/The Deception of Distance | **Personal exhibitions**
*The
Deception of Distance*,
Mikhail Bulgakov's Museum, Kyiv, Ukraine
**Group exhibitions:**
Lest The Two Seas Meet, Museum of Modern Art Warsaw (Poland, 2015) –[Personal shield](personalnij-sit-personal-shield-1)
The school of Kyiv. Leipzig class. Seminar: Politics of Form, Galerie für
Zeitgenössische Kunst (Leipzig, Germany, 2015) – Constructing the new landscape
Walk the Line. Neue Wege der
Zeichnung, Kunstmuseum Wolfsburg (Germany,
2015) – Constructing the new landscape
Meshes of the Afternoon, Kunsthalltrondheim (Norway, 2015) – [Three points of view on common field and three possibilities to own it](tri-tocki-zoru-na-spilne-pole-ta-tri-mozlivosti-jogo-pridbati-three-points-of-view-on-common-field-and-three-possibilities-to-own-it)
Best evidence rule, Verein für zeitgenössische Kunst Leipzig (Germany,
2015) – –[War in Ukraine](war-in-ukraine) and [The Deception of Distance](obman-distanciie-the-deception-of-distance)*à la frontière…!* *old and new borders in Europe,*Studio Tommaseo, Trieste
Contemporanea – [From left to right](from-left-to-right)
 |
...
[Sign in](https://accounts.google.com/ServiceLogin?continue=http://sites.google.com/a/ladanakonechna.com/ladanakonechna-com/project/2015&service=jotspot)|[Report Abuse](http://sites.google.com/a/ladanakonechna.com/ladanakonechna-com/system/app/pages/reportAbuse)|[Print Page](javascript:;)|Powered By **[Google Sites](http://sites.google.com/site)**
